...
public class SessionManager {
        ...
        private static final String PREF_NAME = "multipay_pf_file";
        ...
        public void createLoginSession(String name, String email, String loginType) {
                ...
                this.editor.putString(KEY_LOGIN_TYPE, loginType);
        ...
        public HashMap<String, String> getUserDetails() {
                ...
                // user loginType id
                user.put(KEY_LOGIN_TYPE, this.pref.getString(KEY_LOGIN_TYPE, null));
